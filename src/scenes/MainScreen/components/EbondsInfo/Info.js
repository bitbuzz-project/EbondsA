...
import imageUrl from './images/EBONDSLogo.png'
...
const Info = ({ total, totaldist }) => {
  ...
  const address = '0x53Ee546eB38fB2C8b870f56DeeaeCF80367a4551';
const copiedToClipboard = () => toast.info('Address copied to clipboard', {
  ...
  const distributedVar = ((totaldist / 10000000000) * EsirPrice).toFixed(2) ;
      ...
      const purchasedTokens = total / 10000000000; // Example value, replace with your actual purchased token value
      const totalSupply = 1150000; //00 Example value, replace with your actua
      const progressPercentage = (purchasedTokens / totalSupply) * 100;
      return (
        <div className={classes.Info}>
          <div className={classes.featureCards}>
            ...
            <h2>Introducing EBONDS Token</h2>
              <p>EBONDS are asset backed by collateral contributions to the strategies, and only EBONDS stakers earn ESIR tokens. A maximum supply of 7.000.000# EBONDS Tokens will ever be in circulation. The starting circulation amount will be 1.150.000# and after successfully hitting this mark and distribute community bonuses, we can mint more batches for more phases.</p>
              <p>EBONDS Price : $0.90</p>
              <p>Total Sold: </p>
              <div className={classes.progressBar}>
        <div className={classes.progress} style={{ width: `${progressPercentage}%` }}>
 
        </div>
        
      </div>
              <p className={classes.CopyInput}>
              0x53Ee546eB38fB2C8b870f56DeeaeCF80367a4551  <div className={classes.element} onClick={() => { navigator.clipboard.writeText(address); copiedToClipboard() }}>
...
<a href="https://arbiscan.io/address/0x53ee546eb38fb2c8b870f56deeaecf80367a4551" className={classes.btn}>
    Go to Explorer
</a>
