...
export default function FetchCSVData(props) {
    ...
    const fetchCSVData = () => {
    const csvUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vRryGmqrO31zIQ_WL0x_5FHp0PwSoPHchV5ieLCI0_bbirF7b5UPmeEVs7MhVb-tceZJNAt_4KZkc-y/pub?output=csv'; // Replace with your Google Sheets CSV file URL
